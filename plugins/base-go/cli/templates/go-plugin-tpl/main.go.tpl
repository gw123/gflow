...
func (p *{{.StructName}}) GetMetadata(ctx context.Context) (*pb.GetMetadataResponse, error) {
...
func (p *{{.StructName}}) Run(req *pb.RunRequest, stream pb.NodePluginService_RunServer) error {
	// Parse parameters
