...
export class LangChainNodeRunner implements NodeRunner {
  async run(node: NodeDefinition, context: NodeRunnerContext): Promise<Partial<NodeExecutionResult>> {
    ...
    // Since we don't have the full heavyweight LangChain.js library bundled,
    // we simulate the ReAct loop using the LLM directly, which is lighter and faster for this UI.
